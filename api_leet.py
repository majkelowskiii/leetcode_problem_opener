...
headers = ['stat.frontend_question_id', 'stat.question__title', 
           'stat.question__title_slug', 'difficulty.level', 'paid_only','status']
...
headers = ['Rating', 'ID', 'Title_x', 'Title Slug_x',
       'Difficulty', 'premium', 'status']
